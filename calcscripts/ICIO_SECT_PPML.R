## =====================================================================
##  ICIO_SECT_PPML.R                                      (script 4 of 10)
##  PPML (Poisson pseudo-maximum-likelihood) gravity regressions on the
##  SECTORAL OECD ICIO dyadic data. One regression per (sector, year).
##  Dependent variable = Vol in LEVELS; continuous regressors log-transformed.
##
...
##    [[2]] sectors
##    [[3]] years
##  saved to '3D_grav_sect_time_1_Y_PPML.RData'.
## =====================================================================
...
output_file <- "3D_grav_sect_time_1_Y_PPML.RData"
