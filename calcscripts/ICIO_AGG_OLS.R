## =====================================================================
##  ICIO_AGG_OLS.R                                        (script 1 of 10)
##  Yearly log-log OLS gravity regressions on the AGGREGATED OECD ICIO
##  dyadic data. One regression per year.
##
...
##  saved to '2D_GRAV_TIME_1_Y_OLS.RData'.
## =====================================================================
...
output_file <- "2D_GRAV_TIME_1_Y_OLS.RData"        # output .RData
