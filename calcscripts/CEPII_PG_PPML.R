## =====================================================================
##  CEPII_PG_PPML.R                                       (script 6 of 10)
##  PPML (Poisson pseudo-maximum-likelihood) gravity regressions on the
##  CEPII BACI data aggregated to 2-digit product groups.
...
##
##  Results: two 3D arrays saved to '3D_grav_products_time_20_PPML.RData':
...
output_file <- "3D_grav_products_time_20_PPML.RData"
