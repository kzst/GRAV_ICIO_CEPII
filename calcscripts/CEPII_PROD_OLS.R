## =====================================================================
##  CEPII_PROD_OLS.R                                      (script 9 of 10)
##  Log-log OLS gravity regressions on the RAW (non-aggregated) 6-digit
##  CEPII BACI data. One regression per (product, year).
##
...
##
##  Results: two 3D arrays saved to '3D_grav_products_time_ALL_OLS.RData':
...
output_file <- "3D_grav_products_time_ALL_OLS.RData"
